...
from .forms import (Edp_form, form_recursos_edp)
...
def adicionar_recursos(request, slug):
    ...
    if request.method == "POST":
            ...
            if form.is_valid():
                ...
                recursos_edp.save()
                print("aui2")
                return HttpResponseRedirect(reverse('/edps/') )
...
#             video_form.video= uploaded_file_url
#             video_form.save()
#             print(video_form.video)
#             return HttpResponse("que feliz")
